...
import { modifyTodo } from '../redux/slices/todosSlice';
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <div className="modal-title">
                            Modifying of task <b>{taskTitle}</b>
                        </div>
                        <button
                            type="button"
                            className="btn-close"
                    ...
                    <form>
                        ...
                        <div className="modal-footer">
                            <button
                                type="button"
                                className="modal-close-button btn btn-success"
                            ...
                            <button
                                type="button"
                                className="modal-close-button btn btn-danger"
                                onClick={onClose}
                            >
                                Cancel
                            </button>
